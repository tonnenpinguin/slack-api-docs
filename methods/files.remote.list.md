...
HTTP
`GEThttps://slack.com/api/files.remote.list`
...
[Bot tokens](/docs/token-types#granular_bot)[`remote_files:read`](/scopes/remote_files:read)

[User tokens](/docs/token-types#user)[`remote_files:read`](/scopes/remote_files:read)
