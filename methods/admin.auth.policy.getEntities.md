...
HTTP
`POSThttps://slack.com/api/admin.auth.policy.getEntities`
...
This [Admin API method](/admins) gets the entities (currently, users) assigned to a particular authentication policy in your organization—for example, signing in with email and password.
