...
HTTP
`POSThttps://slack.com/api/users.setPresence`
...
[Bot tokens](/docs/token-types#granular_bot)[`users:write`](/scopes/users:write)

[User tokens](/docs/token-types#user)[`users:write`](/scopes/users:write)
