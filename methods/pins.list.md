...
HTTP
`GEThttps://slack.com/api/pins.list`
...
[Bot tokens](/docs/token-types#granular_bot)[`pins:read`](/scopes/pins:read)

[User tokens](/docs/token-types#user)[`pins:read`](/scopes/pins:read)
