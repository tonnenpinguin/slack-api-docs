...
HTTP
`POSThttps://slack.com/api/calls.info`
...
[Bot tokens](/docs/token-types#granular_bot)[`calls:read`](/scopes/calls:read)

[User tokens](/docs/token-types#user)[`calls:read`](/scopes/calls:read)
