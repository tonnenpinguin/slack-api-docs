...
HTTP
`POSThttps://slack.com/api/stars.add`
...
[Bot tokens](/docs/token-types#granular_bot)[`stars:write`](/scopes/stars:write)

[User tokens](/docs/token-types#user)[`stars:write`](/scopes/stars:write)
