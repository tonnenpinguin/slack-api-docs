...
HTTP
`POSThttps://slack.com/api/admin.inviteRequests.deny`
...
[User tokens](/docs/token-types#user)[`admin.invites:write`](/scopes/admin.invites:write)
...
The `invite_request_id` passed is invalid.
 |
| `already_processed` | 
The request has been previously processed and is not pending anymore
 |
| `feature_not_enabled` | 
