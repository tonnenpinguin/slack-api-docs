...
HTTP
`GEThttps://slack.com/api/users.identity`
...
[User tokens](/docs/token-types#user)[`identity.basic`](/scopes/identity.basic)
...
Note: When users sign into Slack via Apple, their emails appear as anonymized relay addresses. [Sign in with Slack](/docs/sign-in-with-slack#exceptions) won't work with these users.
