...
HTTP
`POSThttps://slack.com/api/admin.users.session.resetBulk`
...
Note: An ok response from this endpoint does not mean all sessions have been reset. This process is asynchronous. It means that the job that performs the reset has successfully been enqueued.
