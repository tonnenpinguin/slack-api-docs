...
HTTP
`GEThttps://slack.com/api/files.remote.share`
...
[Bot tokens](/docs/token-types#granular_bot)[`remote_files:share`](/scopes/remote_files:share)

[User tokens](/docs/token-types#user)[`remote_files:share`](/scopes/remote_files:share)
