...
HTTP
`GEThttps://slack.com/api/emoji.list`
...
[Bot tokens](/docs/token-types#granular_bot)[`emoji:read`](/scopes/emoji:read)

[User tokens](/docs/token-types#user)[`emoji:read`](/scopes/emoji:read)
