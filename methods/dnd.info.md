...
HTTP
`GEThttps://slack.com/api/dnd.info`
...
[Bot tokens](/docs/token-types#granular_bot)[`dnd:read`](/scopes/dnd:read)

[User tokens](/docs/token-types#user)[`dnd:read`](/scopes/dnd:read)
...
The `snooze_is_indefinite` property indicates snooze will not automatically end and will remain in effect until the user turns it off.
